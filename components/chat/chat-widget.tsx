...
const GREETING = {
  ...
  content:
    "AGENT INITIALIZED. I represent Raja's work and skills. Query anything — projects, stack, philosophy, availability.",
};
...
export function ChatWidget() {
  ...
  return (
    <div
      className="widget-open scanlines fixed inset-x-4 top-20 z-50 flex flex-col border border-[#1E1E28] bg-[#0F0F14] sm:inset-x-auto sm:right-4 sm:w-[400px] md:right-7"
      style={{
        height: "min(560px, calc(100dvh - 6rem))",
        borderRadius: "4px",
        boxShadow: "0 0 0 1px #1E1E28, 0 24px 60px rgba(0,0,0,0.8)",
      }}
    >
      {/* Terminal header */}
      <div className="relative z-10 flex items-center justify-between px-4 py-2.5 border-b border-[#1E1E28] bg-[#0D0D12] shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[#10B981] text-[11px] font-mono tracking-widest">
              LIVE
            </span>
          </div>
        </div>
      ...
      >
        <span className="text-[#00D9FF] text-xs font-mono pl-3 pr-1 select-none shrink-0">
          &gt;
        </span>
        <input
          ref={inputRef}
